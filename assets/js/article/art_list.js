    ...
    function renderPage(total) {
        ...
        laypage.render({
            ...
            jump: function (obj, first) {
                ...
                q.pagenum = obj.curr;
                // 把最新的条目数复制到q这个查询参数对象的pagesize属性中
        ...
        layer.confirm('确认删除?', { icon: 3, title: '提示' }, function (index) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    // 如果没有剩余的数据,则让页码值-1之后,在重新调用initTable()方法
                    if (len === 1) {
                        // 如果len的值等于1,说明删除完毕之后页面上没有任何数据了
                        // 页码值最小必须是1
